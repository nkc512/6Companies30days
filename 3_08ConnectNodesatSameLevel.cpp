...
class Solution
{
    ...
    void connect2(Node *root)
    {
        ...
        {
            root->left->nextRight=nullptr;
            if(root->right!=nullptr)
                root->left->nextRight=root->right;
            else if(root->nextRight!=nullptr && root->nextRight->left!=nullptr)
            {
                root->left->nextRight=root->nextRight->left;
            }
            else if(root->nextRight!=nullptr && root->nextRight->right!=nullptr)
                root->left->nextRight=root->nextRight->right;
        }
        if(root->right !=nullptr)
        {
            root->right->nextRight=nullptr;
            if(root->nextRight!=nullptr && root->nextRight->left!=nullptr)
            {
